...
function isRAppContentType(type: ContentType): boolean {
  return type === ContentType.R_PLUMBER || type === ContentType.R_SHINY;
}
...
export async function normalizeConfig(
  ...
  // Discover linked resources for content types whose detectors don't already

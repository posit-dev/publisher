...
describe("patchDeploymentRecord", () => {
  ...
  it("strips comments from nested configuration section", async () => {
    ...
    expect(content).not.toMatch(/comments\s*=/);
  });

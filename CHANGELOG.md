...
- Clicking "Scan" to generate a Python requirements file, or "Set up renv" to create an R lockfile now also adds that file to your configuration's file list. (#4400)

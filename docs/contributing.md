...
See the [Posit Publisher VS Code Extension CONTRIBUTING guide](https://github.com/posit-dev/publisher/blob/main/extensions/vscode/CONTRIBUTING.md)
...
See the **[E2E Testing Guide](https://github.com/posit-dev/publisher/blob/main/test/e2e/CONTRIBUTING.md)** for setup and usage instructions.
...
[VS Code Extension](https://github.com/posit-dev/publisher/blob/main/extensions/vscode/CONTRIBUTING.md#debugging) the `cwd`
will frequently be the workspace folder of the extension host development
window.

### Extension Development

See [the Contribution Guide for the VSCode Extension](https://github.com/posit-dev/publisher/blob/main/extensions/vscode/CONTRIBUTING.md).

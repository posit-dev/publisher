...
<template>
  ...
  >
    <template #summary>
      Installing the dependent python packages on the server in order to
      reproduce your runtime environment.
    </template>
  </DeployStep>
</template>
...
const messages = ref(
  eventStore.currentPublishStatus.status.steps.restorePythonEnv.allMsgs,
);
